class Color(object):
    ...
    def __sub__(self, other_color):
        '''Return a new Color made from subtracting the red, green, \
        and blue components of this Color from Color other_color's \
        components. If the difference is less than 0, then the color \
        is set to 0.'''
